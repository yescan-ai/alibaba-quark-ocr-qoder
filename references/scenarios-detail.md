...
本文档包含所有17个OCR场景的完整触发条件、scene标识和示例指令。
...
12. [行驶证识别](#12-行驶证识别)
13. [英文发票识别](#13-英文发票识别)
14. [医疗报告单识别](#14-医疗报告单识别)
15. [营业执照识别](#15-营业执照识别)
16. [商品图片识别](#16-商品图片识别)
17. [通用文字提取（兜底）](#17-通用文字提取兜底)
...
## 16. 商品图片识别
- **触发意图**：当用户需要识别商品图片或商品包装中的文字信息、提取包装或标签上的内容（包括但不限于商品名称、品牌、规格、成分、生产信息、使用说明、条码等）、将商品包装图片转化为文字或结构化数据，或应用于商品信息录入、商品上架、商品检索及商品信息分析等场景的意图。
